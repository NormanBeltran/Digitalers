...
class Gender(models.Model):  # Géneros de las Películas
...
class Company(models.Model):  # Compañía productora de la Película
...
class Movie(models.Model):
    name = models.CharField(verbose_name="Película", max_length=100) 
